/*Используются материалы из кгниги Моргунов Е.П. под. ред. Е.В. Рогова ДМК Пресс, 2025.
...
/*Добавим в таблицу вычисляемые столбцы для хранения имени и фамилии. Для этого воспользуемся предложением
  GENERATED ALWAYS. Во включенным в него выражении для вычисления значений столбца допускаются вызовы
...
/*Сортировка массивов разной размерности
  в разеделе 9.19 функции и операторы работы с массивами представлено много разнообразных функций для
  обработки массивов, однако функции сортирочки среди них нет. Давайте ее напишем, но сначала уточним,
  что мы понимаем под сортировкой массива. В случае одномерного массива речь идет о сортировке его
  элементов. Элементами двухмерного массива являются одномерные массивы, поэтому сначала сортируются
  элементы каждого одномерного массива, а потом - сами одномерные массивы в лексикографическом порядке.
  Аналогично понимается и сортировка трехмерных массивов, учитывая что их элементы двухмерные массивы
